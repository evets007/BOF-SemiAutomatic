...
################################### Variables ##################################
##Can support upto a length of 5000 bytes, if you need larger pattern, generate and add below
...
if len(sys.argv) < 2:
	print "Choose modules: fuzz / badchars / shell"
	print "Add the target address, port, command and execute. Example: python <filename>.py fuzz"
	sys.exit();
